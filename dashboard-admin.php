  ...
  <main class="admin-main">
      ...
      <div class="tabs-container">
        ...
        <div class="content-area">
          ...
          <div class="tab-content" id="quizzes-tab">
            ...
            <p style="font-size:12px;color:rgba(255,255,255,.45);margin-bottom:14px;">
              💡 Click a row to select it, then use the <strong>UPDATE</strong> or <strong>DELETE</strong> sidebar buttons — or use the inline ✏️ Edit / 🗑️ Delete buttons.
            </p>
            <div class="import-section">
              ...
              <div style="margin-top:10px;font-size:11px;color:rgba(255,255,255,.4);line-height:1.7;">
                ...
                difficulty → <em>easy/medium/hard</em> &nbsp;|&nbsp; correct → <em>A/B/C/D</em>
              </div>
            </div>
            <div class="table-wrapper">
    ...
    <div id="edit-quiz-modal" class="modal hidden">
      <div class="modal-content" style="max-width:720px;">
        ...
        <form id="edit-quiz-form">
          ...
          <!-- Questions -->
          <div style="margin:16px 0 8px;font-size:12px;font-weight:800;color:#00d9ff;letter-spacing:1px;text-transform:uppercase;">
            Questions
          </div>
          <div id="edit-questions-container"></div>

          <button type="button" class="btn-admin btn-secondary" id="edit-add-question-btn"
                  style="margin-bottom:16px;">+ Add Question</button>

          <div class="modal-actions">
            <button type="submit" class="btn-admin btn-primary">💾 Save Changes</button>
            <button type="button" class="btn-admin btn-secondary modal-close-btn"
                    onclick="closeEditQuizModal()">Cancel</button>
          </div>
        </form>
      </div>
    </div>
    ...
    <div id="user-modal" class="modal hidden">
      <div class="modal-content">
        ...
        <form id="user-form">
          <div class="form-group"><label for="user-id">User ID</label><input type="text" id="user-id" readonly></div>
